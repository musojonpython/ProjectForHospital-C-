...
void __fastcall TForm_Shifokorlar_bolim_boshligi_uchun::Bemolarroyxatigaotish1Click(TObject *Sender)

{
	   Form_Shifokorlar_bolim_boshligi_uchun->Close();
	   Form_Bolim_boshligi_uchun_Bemorlar->Caption = "Bo'lim boshliqlarining bemorlar ro'yxati";
